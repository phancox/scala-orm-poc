 ...
 */
class SuburbsDao(ormConnections: OrmConnections)(implicit dbms: String, dataModelVersion: Int)
 ...
 */
class SuburbEntity(implicit dbms: String, dataModelVersion: Int)
  ...
  if (dataModelVersion == 2) { val country = column("COUNTRY".asDbId) to (_.country) }
