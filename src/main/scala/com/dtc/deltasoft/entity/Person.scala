 ...
 */
class PersonsDao(ormConnections: OrmConnections)(implicit dbms: String, dataModelVersion: Int)
 ...
 */
class PersonEntity(implicit dbms: String, dataModelVersion: Int) extends Entity[Int, SurrogateIntId, Person] with Logging {
