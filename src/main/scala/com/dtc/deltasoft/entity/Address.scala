 ...
 */
class AddressesDao(ormConnections: OrmConnections)(implicit dbms: String, dataModelVersion: Int)
 ...
 */
class AddressEntity(implicit dbms: String, dataModelVersion: Int)
